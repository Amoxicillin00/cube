...
public class ByteUtils {
     ...
     * 16进制字符大写
     */
    public final static String STRING_UPPER = "0123456789ABCDEF";

    /**
     * 16进制字符小写
     */
    public final static String STRING_LOWER = "0123456789abcdef";
    ...
    public static byte charToHexByte(char c, boolean upperCase) {
        if (upperCase) {
            return (byte) STRING_UPPER.indexOf(c);
        }
        return (byte) STRING_LOWER.indexOf(c);
    }
